...
import { ScheduleArgs, ScheduleNowArgs, ScheduleUniqueArgs, get_milli_secs } from "@server/tasks";
...
export const post_task_d_3_min = debounce(post_task, get_milli_secs("3 minutes"))
export const post_task_d_5_min = debounce(post_task, get_milli_secs("5 minutes"))
export const post_task_d_10_min = debounce(post_task, get_milli_secs("10 minutes"))
export const post_task_d_15_min = debounce(post_task, get_milli_secs("15 minutes"))
export const post_task_d_30_min = debounce(post_task, get_milli_secs("30 minutes"))
export const post_task_d_60_min = debounce(post_task, get_milli_secs("60 minutes"))