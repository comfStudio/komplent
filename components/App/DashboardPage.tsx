...
class DashboardPage extends AuthPage<Props> {
    ...
    static async getInitialProps(ctx) {
        ...
        let useNotificationStoreState = useNotificationStore.createState({
            notifications: await useNotificationStore.actions.get_notifications(props.useUserState.current_user)
        })
    ...
    renderPage(children) {
        return (
            <useFollowerStore.Provider initialState={this.props.useFollowerStoreState}>
                <useNotificationStore.Provider initialState={this.props.useNotificationStoreState}>
